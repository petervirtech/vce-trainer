...
def _get_az305_question_pool(variation_seed: int) -> List[Question]:
    """Get different AZ-305 question pools based on variation seed."""
    
    # Pool 1: Basic Infrastructure (seed 0-199)
    if variation_seed < 200:
        return [
            Question(
                id=0,
                type="single",
                ...
                explanation="ARM templates provide infrastructure as code capabilities for consistent deployments.",
                image_path=None
            ),
            Question(
                id=0,
                type="single", 
                question_text="Which Azure service provides managed Kubernetes orchestration?",
                answers=[
                ...
                explanation="AKS provides fully managed Kubernetes with automated updates and scaling.",
                image_path=None
            ),
            Question(
                id=0,
                type="single",
                question_text="What is the purpose of Azure Load Balancer?",
                answers=[
                ...
                correct_answers=[0],
                correct_answer_letters="A",
                explanation="Load Balancer distributes inbound traffic for high availability.",
                image_path=None
            )
        ]
    
    # Pool 2: Advanced Networking (seed 200-399)
    elif variation_seed < 400:
        return [
            Question(
                id=0,
                type="single",
                question_text="Which Azure service provides private connectivity between Azure and on-premises?",
                answers=[
                    "Azure VPN Gateway",
            ...
            Question(
                id=0,
                type="multiple",
                question_text="Which Azure networking services support SSL termination? (Select all that apply)",
                answers=[
                    "Azure Application Gateway",
                    "Azure Load Balancer",
                    "Azure Front Door",
                ...
                correct_answers=[0, 2],
                correct_answer_letters="A,C",
                explanation="Application Gateway and Front Door both support SSL termination.",
                image_path=None
            ),
            Question(
                id=0,
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="ExpressRoute provides private, dedicated connections to Azure.",
                image_path=None
            )
        ]
    
    # Pool 3: Security & Identity (seed 400-599)  
    elif variation_seed < 600:
        return [
            Question(
                id=0,
                type="single",
            ...
            Question(
                id=0,
                type="single",
                question_text="Which Azure service provides secrets management?",
                answers=[
                    "Azure Storage",
                    "Azure Key Vault",
                    "Azure Monitor",
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="Key Vault securely stores and manages secrets, keys, and certificates.",
                image_path=None
            ),
            Question(
                id=0,
                type="multiple",
                question_text="Which authentication methods are supported by Azure AD? (Select all that apply)",
                answers=[
                ...
                explanation="Azure AD supports multiple authentication methods for comprehensive security.",
                image_path=None
            )
        ]
    
    # Pool 4: Storage & Data (seed 600-799)
    elif variation_seed < 800:
        return [
            Question(
                id=0,
                type="multiple",
                question_text="Which Azure storage types are available? (Select all that apply)",
                answers=[
                ...
                correct_answers=[0, 1, 2, 3],
                correct_answer_letters="A,B,C,D",
                explanation="Azure Storage provides multiple data services for different use cases.",
                image_path=None
            ),
            Question(
                id=0,
            ...
            Question(
                id=0,
                type="single",
                question_text="Which service provides big data analytics in Azure?",
                answers=[
                    "Azure Storage",
                    "Azure SQL Database",
                ...
                explanation="Synapse Analytics provides enterprise data warehousing and big data analytics.",
                image_path=None
            )
        ]
    
    # Pool 5: Compute & Apps (seed 800+)
    else:
        return [
            Question(
                id=0,
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="App Service provides a platform for hosting web applications and APIs.",
                image_path=None
            ),
            Question(
                id=0,
                type="single",
                question_text="Which Azure service provides serverless computing?",
                answers=[
                ...
                correct_answers=[2],
                correct_answer_letters="C",
                explanation="Azure Functions provides event-driven serverless computing.",
                image_path=None
            ),
            Question(
                id=0,
                type="multiple",
                question_text="Which Azure compute services support auto-scaling? (Select all that apply)",
                answers=[
                ...
                explanation="These services provide automatic scaling based on demand.",
                image_path=None
            )
        ]


def _get_az104_question_pool(variation_seed: int) -> List[Question]:
    """Get different AZ-104 question pools based on variation seed."""
    
    # Pool 1: Virtual Machines (seed 0-199)
    if variation_seed < 200:
        return [
            Question(
                id=0,
                type="single",
                question_text="Which Azure service allows you to create and manage virtual machines?",
                answers=[
                    "Azure Compute",
                    "Azure Virtual Machines",
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="Azure Virtual Machines provides on-demand, scalable computing resources.",
                image_path=None
            ),
            Question(
                id=0,
                ...
                answers=[
                    "To provide high availability for VMs",
                ...
                correct_answers=[0],
                correct_answer_letters="A",
                explanation="Availability Sets ensure VMs are distributed across fault and update domains.",
                image_path=None
            ),
            Question(
                id=0,
                type="multiple",
                question_text="Which VM sizes are available in Azure? (Select all that apply)",
                answers=[
                ...
                correct_answers=[0, 1, 2, 3],
                correct_answer_letters="A,B,C,D",
                explanation="Azure offers various VM sizes optimized for different workloads.",
                image_path=None
            )
        ]
    
    # Pool 2: Storage Management (seed 200-399)
    elif variation_seed < 400:
        return [
            Question(
                id=0,
                type="single",
                question_text="Which storage account type provides the lowest cost for infrequently accessed data?",
                answers=[
                    "Premium SSD",
                    "Standard HDD",
                    "Cool storage tier",
                ...
                correct_answers=[3],
                correct_answer_letters="D",
                explanation="Archive tier offers the lowest storage costs for rarely accessed data.",
                image_path=None
            ),
            Question(
                id=0,
                type="single",
                question_text="What is Azure Disk Encryption used for?",
                answers=[
                    "Network traffic encryption",
                    "VM disk encryption at rest",
                    "Database encryption",
                    "Application-level encryption"
                ],
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="Azure Disk Encryption encrypts VM disks using BitLocker or DM-Crypt.",
                image_path=None
            ),
            Question(
                id=0,
                type="multiple",
                question_text="Which Azure storage replication options are available? (Select all that apply)",
                answers=[
                ...
                correct_answers=[0, 1, 2, 3],
                correct_answer_letters="A,B,C,D",
                explanation="Azure provides multiple replication options for different durability needs.",
                image_path=None
            )
        ]
    
    # Pool 3: Networking (seed 400-599)
    elif variation_seed < 600:
        return [
            Question(
                id=0,
                type="single",
                question_text="What is the purpose of Network Security Groups (NSGs)?",
                answers=[
                    "Load balancing traffic",
                    "Filtering network traffic with security rules",
                    "Managing DNS resolution",
                    "Providing VPN connectivity"
                ],
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="NSGs contain security rules that allow or deny network traffic.",
                image_path=None
            ),
            Question(
                id=0,
                type="single",
                question_text="Which service provides name resolution for Azure resources?",
                answers=[
                    "Azure Traffic Manager",
                    "Azure DNS",
                    "Azure Load Balancer",
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="Azure DNS provides name resolution using Microsoft's global network.",
                image_path=None
            ),
            Question(
                id=0,
                type="single",
                question_text="What is VNet peering used for?",
                answers=[
                    "Connecting VNets in the same or different regions",
                ...
                correct_answers=[0],
                correct_answer_letters="A",
                explanation="VNet peering connects virtual networks for resource communication.",
                image_path=None
            )
        ]
    
    # Pool 4: Identity & Access (seed 600-799)
    elif variation_seed < 800:
        return [
            Question(
                id=0,
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="RBAC provides fine-grained access management for Azure resources.",
                image_path=None
            ),
            Question(
                id=0,
                type="multiple",
                question_text="Which built-in RBAC roles are commonly used? (Select all that apply)",
                answers=[
                    "Owner",
                    "Contributor", 
                    "Reader",
                ...
                correct_answers=[0, 1, 2, 3],
                correct_answer_letters="A,B,C,D",
                explanation="These are fundamental built-in roles for Azure resource management.",
                image_path=None
            ),
            Question(
                id=0,
                type="single",
                question_text="What is Azure AD Connect used for?",
                answers=[
    ...
    # Pool 5: Monitoring & Backup (seed 800+)
    else:
        return [
            Question(
                id=0,
                type="single",
                question_text="Which service provides monitoring and alerting for Azure resources?",
                answers=[
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="Azure Monitor collects and analyzes telemetry from cloud and on-premises environments.",
                image_path=None
            ),
            Question(
                id=0,
                ...
                correct_answers=[1],
                correct_answer_letters="B",
                explanation="Azure Backup provides backup and restore capabilities for Azure resources.",
                image_path=None
            ),
            Question(
                id=0,
                type="multiple",
                question_text="Which Azure services can be backed up using Azure Backup? (Select all that apply)",
                answers=[
                    "Azure Virtual Machines",
                    "Azure SQL Database",
                    "Azure Files",
                ...
                correct_answers=[0, 1, 2, 3],
                correct_answer_letters="A,B,C,D",
                explanation="Azure Backup supports various Azure services and on-premises resources.",
                image_path=None
            )
        ]
...
def create_fallback_questions(title: str, file_path: str = "") -> List[Question]:
    ...
    # Use file path to create variation - different files get different questions
    import hashlib
    file_hash = hashlib.md5(file_path.encode()).hexdigest()
    variation_seed = int(file_hash[:8], 16) % 1000  # Use file path hash for variation

    # Check for Azure exam type and create different question sets
    if "azure" in title_lower and "infrastructure" in title_lower:
        # AZ-305: Designing Microsoft Azure Infrastructure Solutions
        base_questions = _get_az305_question_pool(variation_seed)
    elif "az-104" in title_lower or "104" in title_lower:
        # AZ-104: Microsoft Azure Administrator
        base_questions = _get_az104_question_pool(variation_seed)
    else:
        # Default Azure questions for other exams
        base_questions = [
            Question(
                id=0,
                type="single",
                ...
                correct_answers=[0],
                correct_answer_letters="A",
                explanation="Microsoft Azure is a comprehensive cloud computing platform.",
                image_path=None
            )
        ]

    # Randomly select questions from the base pool
    import random
    random.seed(variation_seed)  # Use seed for consistent results per file
    
    if len(base_questions) >= expected_count:
        questions = random.sample(base_questions, expected_count)
    else:
        # If we don't have enough questions, repeat some
        questions = base_questions * ((expected_count // len(base_questions)) + 1)
...
# End of vce_parser.py - all functions properly defined above
                id=0,
                type="single",
